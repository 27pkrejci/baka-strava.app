...
def upload_schedule(code: str, class_name: str, confirm: bool = True, dry_run: bool = False) -> int:
...
def main(argv: List[str] = None) -> int:
    ...
    try:
        inserted = upload_schedule(args.code, args.class_name, confirm=not args.yes, dry_run=args.dry_run)
        print("Done.")
        return 0
